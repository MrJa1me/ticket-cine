 ...
 * Equivalente al ms-catalogo de biblioteca, pero sobre Peliculas del catálogo.
 */
@Configuration
@EnableWebSecurity
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Consulta de Peliculas y validaciones Feign (existe/id...)
                .requestMatchers(HttpMethod.GET, "/api/v1/Peliculas/**")
                    .hasAnyRole("Cliente", "Organizador", "Administrador")

                // Alta, edición y baja de Peliculas
                .requestMatchers(HttpMethod.POST, "/api/v1/Peliculas/**")
                    .hasAnyRole("Organizador", "Administrador")
                .requestMatchers(HttpMethod.PUT, "/api/v1/Peliculas/**")
                    .hasAnyRole("Organizador", "Administrador")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/Peliculas/**")
                    .hasAnyRole("Organizador", "Administrador")
