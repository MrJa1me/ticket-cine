...
import cl.ticketcine.common.event.BoletoEvent;
...
public class BoletoEventProducer {
    ...
    private void send(BoletoEvent event, String eventType) {
        ...
        log.debug("********************");
        log.debug("");
        log.debug("Enviando Pelicula Kafka → topic: {}, key: {}", topic, idBoleto);
        log.debug("");
        log.debug("********************");
        log.debug("********************");
        log.debug("********************");
        ...
        // No esperamos respuesta, solo "gritamos" el Pelicula y seguimos con nuestra vida.
    }
