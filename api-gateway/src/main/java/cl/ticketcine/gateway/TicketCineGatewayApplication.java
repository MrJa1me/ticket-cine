...
/**
 * Clase principal del API Gateway del proyecto TicketCine.
 *
...
public class TicketCineGatewayApplication {

    public static void main(String[] args) {
        SpringApplication.run(TicketCineGatewayApplication.class, args);
    }
