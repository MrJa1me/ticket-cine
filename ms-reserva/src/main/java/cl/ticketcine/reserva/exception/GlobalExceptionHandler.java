...
public class GlobalExceptionHandler {
    ...
    /**
     * Captura búsquedas de asientos inexistentes por ID.
     * Devuelve 404 NOT FOUND con el mensaje de la excepción de dominio.
     */
    @ExceptionHandler(asientoNotFoundException.class)
    public ResponseEntity<ApiError> handleAsientoNotFound(
            asientoNotFoundException ex,
    ...
    /**
     * Captura búsquedas de salas inexistentes por ID.
     * Devuelve 404 NOT FOUND con el mensaje de la excepción de dominio.
     */
    @ExceptionHandler(salaNotFoundException.class)
    public ResponseEntity<ApiError> handleSalaNotFound(
    ...
    /**
     * Captura búsquedas de mantenimientos inexistentes por ID.
     * Devuelve 404 NOT FOUND con el mensaje de la excepción de dominio.
     */
