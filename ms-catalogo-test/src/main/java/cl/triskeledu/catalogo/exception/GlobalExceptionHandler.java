...
public class GlobalExceptionHandler {
    ...
    /**
     * Captura búsquedas de libros inexistentes (por ID o ISBN).
    ...
    /**
     * Captura intentos de crear o actualizar libros con ISBN duplicado.
    ...
    public ResponseEntity<ApiError> handleIsbnDuplicado(
     ...
     * más específicos.
     *
     * Además, aquí se detectan manualmente casos de endpoints inexistentes
